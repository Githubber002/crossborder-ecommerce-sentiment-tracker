    ...
    <div className="flex flex-col items-center">
      <div className="relative h-44 w-72 md:h-52 md:w-96">
        <svg viewBox="0 0 300 170" className="h-full w-full">
          ...
          {/* Labels */}
          <text x="30" y="168" fill="hsl(0, 65%, 50%)" fontSize="9" fontFamily="Inter, sans-serif" fontWeight="500" textAnchor="middle">Negative</text>
          ...
          <circle cx="150" cy="150" r="6" fill="hsl(0, 0%, 20%)" />
